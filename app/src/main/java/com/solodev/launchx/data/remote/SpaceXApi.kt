...
class SpaceXApi(
    ...
    suspend fun getRockets(): List<Rocket> = client.get("rockets").body()

    suspend fun getCrews(): List<Crew> = client.get("crew").body()

    suspend fun getLandpads(): List<Landpad> = client.get("landpads").body()
}
